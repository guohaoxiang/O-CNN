...
The implementation of our *O-CNN*  and  *Aadptive O-CNN* 
introduced in our SIGGRAPH 2017 paper and SIGGRAPH Asia 2018 paper is released in https://github.com/microsoft/O-CNN.  The code is released under the **MIT license**.
